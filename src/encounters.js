...
export class Encounters {
  ...
  update(dt){
    ...
    this.blades.forEach((b,i)=>{const outer=g.skillEvolutions.orbit&&i%2===0,radius=outer?3.4:2.15,a=g.time*(outer?-3.5:2.8)+i*Math.PI*2/this.blades.length;b.position.set(p.x+Math.cos(a)*radius,.7,p.z+Math.sin(a)*radius);b.rotation.y=-a;});
